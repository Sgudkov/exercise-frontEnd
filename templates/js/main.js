$(document).ready(function(){
 ...
 $('.slider img:last').clone().prependTo('.slider');   // Копия последнего слайда помещается в начало. 
  ...
  nextSlide();                                          // Вызов функции nextSlide()
    ...
    $(this).parent().find('.radio-btn').removeClass('selected');
...
$("#characters").click(function(){
		$(".info-header").toggleClass("info-marg");
		$("#accordion-btn").fadeToggle(5);
		$(".radio-btn").fadeToggle(5);
		$(".char-txt").fadeToggle(5);
		$("#radio-value").fadeToggle(5);
		$(".info-content").fadeToggle(5);
});
